...
#
# However, when we do this, we also import `sorting_algo/__init__.py'. If this
...
setup_dict = dict(
    ...
    long_description=read('../../Documentation/ProjectDevelopment/DevTools.md'),
    ...
    entry_points={
        'console_scripts': [
            'sorting_algo_cli = sorting_algo.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'sorting_algo_gui = sorting_algo.gui:entry_point'
        # ]
    }
)
